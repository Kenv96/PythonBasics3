...
#Test case for starts_with_non_number
    def test_starts_with_non_number(self):
        ...
        self.assertEqual(pythonBasics3.starts_with_non_number("this is a sentence"), True)

        self.assertEqual(pythonBasics3.starts_with_non_number("Hello world"), True)

        self.assertEqual(pythonBasics3.starts_with_non_number("7 is a lucky number"), False)
...
#Test case for multiple_words
    def test_multiple_words(self):
        ...
        self.assertEqual(pythonBasics3.multiple_words("biglongwordwithnospace"), False)
        
        self.assertEqual(pythonBasics3.multiple_words("i hope this works!"), True)

        self.assertEqual(pythonBasics3.multiple_words("testing testing 1 2 3"), True)
